    ...
    .then(data => {
      ...
      if (priceFilter) {
        const filteredProducts = data.data.filter(product =>
          ...
          priceFilter.between201and999 && product.price >= 201 && product.price <= 999 ||
          priceFilter.between1000and1999 && product.price >= 1000 && product.price <= 1999 ||
          priceFilter.above2000 && product.price > 2000 ||
          !priceFilter.below200 && !priceFilter.between201and999 && !priceFilter.between1000and1999 && !priceFilter.above2000
        );
