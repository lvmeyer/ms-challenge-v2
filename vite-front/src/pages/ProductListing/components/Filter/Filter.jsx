          ...
          <div className="price-container">
            ...
            <div className="price-input-container">
              <label htmlFor="below-200">
                Below $200
                <input type="checkbox" name="below-200" id="below-200" 
                  checked={priceFilter.below200}
                  onChange={() => setPriceFilter(prevFilter => ({
                    ...prevFilter,
              ...
              <label htmlFor="201-999">
                $201 - $999
                <input type="checkbox" name="201-999" id="201-999"
              ...
              <label htmlFor="1000-1999">
                $1000 - $1999
                <input type="checkbox" name="1000-1999" id="1000-1999"
              ...
              <label htmlFor="above 2000">
                Over $2000
                <input type="checkbox" name="above 2000" id="above 2000"
          ...
          <div className="sorting-container">
            ...
            <div className="sorting-input-container">
              <label htmlFor="high-to-low">
                Price-high to low
                <input type="radio" name="price-sorting" id="high-to-low"
              ...
              <label htmlFor="low-to-high">
                Price-low to high
                <input type="radio" name="price-sorting" id="low-to-high"
